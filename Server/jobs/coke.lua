...
TriggerServerEvent('Ilegal:GetPriceCoke', itemid)

RegisterNetEvent("Ilegal:GotPriceCoke")
AddEventHandler("Ilegal:GotPriceCoke", function(ActualPrice)
    Price = ActualPrice
end)
          ...
          if distanceWeedFarm < Position.vente.distance then
             ...
             if IsControlJustPressed(1, 38) then
                  ...
                  if weedcount ~= 0 then
                          ...
                          ShowMsgtime.msg = '~g~ +'..Price..'$'
                          ShowMsgtime.time = 150
                          TriggerEvent("player:sellItem", itemid, Price)
                      TriggerServerEvent('Ilegal:Sell', itemid)  --------CHARLY ADD----------
                  else
                          ShowMsgtime.msg = '~r~ Vous avez pas de coke !'
                          ShowMsgtime.time = 150
                  end
